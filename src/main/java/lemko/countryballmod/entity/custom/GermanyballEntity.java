...
public class GermanyballEntity extends AnimalEntity implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public GermanyballEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.GERMANYBALL.create(world);
    }
