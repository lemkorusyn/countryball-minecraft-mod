...
public class CountryballbaseEntity extends AnimalEntity implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public CountryballbaseEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.COUNTRYBALLBASE.create(world);
    }
